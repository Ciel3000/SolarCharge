...
const CONFIG = {
  ...
  PREMIUM_USER_MAX_ACTIVE_SLOTS: 1,
...
// Backend MQTT client ID - must be unique from ESP32 devices
const BACKEND_MQTT_CLIENT_ID = process.env.MQTT_CLIENT_ID || 'backend-server-001';
